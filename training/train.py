...
exp_name = "test-world/final"       # 設定實驗名稱 (可簡單用代碼，詳細可見 comparison.xlsx) ex.實驗組別/實驗編號
...
plt.savefig('temporaries/figures/' + fig_name + '.png')
img = Image.open('temporaries/figures/' + fig_name + '.png')
img.show()
...
with open('temporaries/confusion-matrix/'+fig_name+'-confusion.txt', 'wb') as f:
    for line in mat:
